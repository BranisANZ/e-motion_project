...
class User implements UserInterface
{
    ...
    public function getLicenseDriving(): ?string
    {
        return $this->licenseDriving;
    }

    public function setLicenseDriving(?string $licenseDriving): self
    {
        $this->licenseDriving = $licenseDriving;
