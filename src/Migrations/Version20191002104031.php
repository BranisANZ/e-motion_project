 ...
 */
final class Version20191002104031 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vehicle CHANGE user_id user_id INT DEFAULT NULL, CHANGE brand brand VARCHAR(255) DEFAULT NULL, CHANGE model model VARCHAR(255) DEFAULT NULL, CHANGE km km INT DEFAULT NULL, CHANGE matriculation matriculation VARCHAR(255) DEFAULT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL, CHANGE photo photo VARCHAR(255) DEFAULT NULL, CHANGE year year DATETIME DEFAULT NULL, CHANGE autonomy autonomy INT DEFAULT NULL, CHANGE door door INT DEFAULT NULL, CHANGE place place INT DEFAULT NULL');
    }
